...
try {
    gameFrame.document.body.style.transform = "scale(1.5)";
    gameFrame.document.body.style.transformOrigin = "top left";
    localStorage.setItem("resolution_scale", 1.25); // opsional
} catch(e) {
