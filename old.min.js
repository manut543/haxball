...
const constrolsStyleBase = "#joystick,#kick{z-index:100;bottom:11vw}.neo{opacity:0.8;background-color:#c2c2c255;box-shadow:6px 6px 10px 0 #a5abb133,-5px -5px 9px 0 #a5abb133;color:#dedede55;font-weight:bolder;font-size:1.5rem}.sizer{width:15%;aspect-ratio: 1 / 1;}#joystick{left:30%;overflow:visible}#thumb{width:100%;height:100%;background-color:#ecf0f3cc}#kick{right:20%}button.neo:active{opacity:0.5}";
