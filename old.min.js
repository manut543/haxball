...
const constrolsStyleBase = "#joystick,#kick{z-index:100;bottom:8vw}.neo{opacity:0.8;background-color:#c2c2c255;box-shadow:6px 6px 10px 0 #a5abb133,-5px -5px 9px 0 #a5abb133;color:#dedede55;font-weight:bolder;font-size:1.5rem}#joystick .sizer{width:12%;aspect-ratio: 1 / 1;}#kick .sizer{width:18%;aspect-ratio: 1 / 1;}#joystick{left:15%;overflow:visible}#thumb{width:96%;height:96%;background-color:#ecf0f3cc}#kick{right:5%}button.neo:active{opacity:0.5}";
